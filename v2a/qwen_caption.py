...
# tokenizer = AutoTokenizer.from_pretrained("qwen_ckpt/Qwen-VL-Chat", trust_remote_code=True)
# model = AutoModelForCausalLM.from_pretrained("qwen_ckpt/Qwen-VL-Chat", device_map="cuda", trust_remote_code=True, use_flash_attn=True).eval()
